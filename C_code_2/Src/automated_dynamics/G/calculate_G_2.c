...
void calculate_G_2(const double q[9], const double dq[9], double *val) {
  ...
  *val = g*m_end_effector*(3.4694469519536142e-18*(x0*x10 - x11*x16)*sin(q_2) + 3.4694469519536142e-18*(0.2582889370066549*x0*x16 + 0.2582889370066549*x10*x11 - 0.24952460252270103*x12 + 0.24952460252270103*x13 - 0.93328682501997218*x14 + 0.93328682501997218*x15)*cos(q_2));
}
