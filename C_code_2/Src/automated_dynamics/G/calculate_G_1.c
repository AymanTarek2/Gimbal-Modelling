...
void calculate_G_1(const double q[9], const double dq[9], double *val) {
  ...
  double x14 = x12*x13;
  *val = g*m_end_effector*(0.012028851236577825*x10*x9 - 0.012028851236577825*x14 + 3.4694469519536142e-18*(0.2582889370066549*x11 - 0.2582889370066549*x14)*sin(q_2) - 3.4694469519536142e-18*(-x10*x13 - x12*x9)*cos(q_2)) + g*m_link_3*(-0.017686989069877607*x11 + 0.017686989069877607*x12*x13);
}
